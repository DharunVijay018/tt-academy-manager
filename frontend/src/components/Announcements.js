...
export default function Announcements() {
  ...
  const fetchAnnouncements = async () => {
    try {
      const response = await axios.get('https://tt-academy-manager.onrender.com/api/announcements/all');
  ...
  const handlePost = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://tt-academy-manager.onrender.com/api/announcements/add', {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://tt-academy-manager.onrender.com/api/announcements/${id}`);
      fetchAnnouncements();
    } catch (error) {
