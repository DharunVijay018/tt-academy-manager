...
export default function FeeManager() {
  ...
  const fetchPlayers = async () => {
    try {
      const res = await axios.get('https://tt-academy-manager.onrender.com/api/players/all');
      setPlayers(res.data);
  ...
  const fetchPayments = async () => {
    try {
      const res = await axios.get('https://tt-academy-manager.onrender.com/api/payments/all');
  ...
  const fetchExpenses = async () => {
    try {
      const res = await axios.get('https://tt-academy-manager.onrender.com/api/expenses/all');
  ...
  const handleQuickPay = async (player) => {
    ...
    try {
      await axios.post('https://tt-academy-manager.onrender.com/api/payments/add', {
  ...
  const handleExpenseSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://tt-academy-manager.onrender.com/api/expenses/add', {
  ...
  const handleDeleteExpense = async (id) => {
    ...
    try {
      await axios.delete(`https://tt-academy-manager.onrender.com/api/expenses/${id}`);
      fetchExpenses();
