...
export default function ClubLeague() {
  ...
  const fetchAllLeagues = async () => {
    try {
      const response = await axios.get('https://tt-academy-manager.onrender.com/api/leagues/all');
  ...
  const createLeague = async () => {
    ...
    try {
      const response = await axios.post('https://tt-academy-manager.onrender.com/api/leagues/add', {
        name: leagueName,
        tablesCount,
  ...
  const updateMatch = async (matchId, winnerId, scoreVal, isCompleted) => {
    try {
      const response = await axios.put(`https://tt-academy-manager.onrender.com/api/leagues/${selectedLeague._id}/match`, {
        matchId: matchId,
        winner: winnerId,
        score: scoreVal,
  ...
  const deleteLeague = async (id, e) => {
    ...
    try {
      await axios.delete(`https://tt-academy-manager.onrender.com/api/leagues/${id}`);
