...
export default function PerformanceAnalytics() {
  ...
  const fetchMatches = async () => {
    try {
      const response = await axios.get('https://tt-academy-manager.onrender.com/api/matches/all');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://tt-academy-manager.onrender.com/api/matches/add', {
